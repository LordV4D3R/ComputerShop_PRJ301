...
<head>
    ...
    <style>
        .checkout-grid { display: grid; grid-template-columns: 3fr 2fr; gap: 20px; margin-top: 30px; }
        ...
        <div class="box">
            ...
            <form action="${pageContext.request.contextPath}/MainController" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="${checkoutEmail}">
                </div>
                <div class="form-group">
                ...
                <div class="msg-success" style="background: #f8f9fa; border-left: 4px solid #1976d2; color: #333;">
                    Thanh toán khi nhận hàng (COD). Đơn sẽ được Staff duyệt sau khi đặt.
                </div>

                <button type="submit" class="btn btn-primary" style="width: 100%; font-size: 16px; padding: 12px;">ĐẶT HÀNG NGAY</button>
            </form>
        </div>
